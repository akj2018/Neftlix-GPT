...
const SecondaryContainer = () => {
  ...
  return (
    <div className="w-full text-white min-h-[500px] bg-[#141414] px-4 lg:pl-16 pr-0  z-[2] absolute pb-8">
      <div className=" -mt-[3rem] md:-mt-[5rem]  lg:-mt-[8rem] xl:-mt-[15rem] overflow-x-hidden">
