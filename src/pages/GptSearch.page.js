...
import GptSearchSuggestion from "../components/Gpt/GptMovieSuggestions";
...
const GPTSearchPage = () => {
  ...
  return (
    <div className="overflow-y-auto min-h-[100vh] bg-black">
      <HeaderBrowse />
      ...
      <div className="w-full flex relative mt-[-20rem]  z-[2]">
        <GptSearchSuggestion />
      </div>
    </div>
  );
